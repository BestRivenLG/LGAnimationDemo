...
//    [shakeView.layer addAnimation:shakeAnimation forKey:nil];
    ...
    CABasicAnimation *shakeAnimation1 = [CABasicAnimation animationWithKeyPath:@"transform.translation.y"];
    shakeAnimation1.duration = 0.25f;
    shakeAnimation1.fromValue = [NSNumber numberWithFloat:-5];
    shakeAnimation1.toValue = [NSNumber numberWithFloat:5];
    shakeAnimation1.autoreverses = YES;
    [shakeView.layer addAnimation:shakeAnimation1 forKey:nil];
